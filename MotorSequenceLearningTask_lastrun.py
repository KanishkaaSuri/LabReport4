...
expName = 'MotorSequenceLearningTask'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kanis\\Desktop\\Lab in Psychology\\4. Motor Sequence Learning Task\\MotorSequenceLearningTask_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('SequenceConditions.csv'),
